...
<template>
  <div class="page_container" :class="details">
    ...
    <div class="details">
      ...
      <input :class="formIndicatorsTitle" class="full-width" type="text" name="title" id="title" v-model="title"
             placeholder="Your title"/>
      <label class="page-label" for="content">Content</label>
      <textarea :class="formIndicatorsContent" name="content" id="content" v-model="content"
      ...
      <i v-if="photo" class="glyphicon glyphicon-open-file open-upload-button"
         @click="postImageOpen = !postImageOpen"></i>
